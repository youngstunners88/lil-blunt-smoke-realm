# Press Kit — Lil Blunt: The Smoke Realm

Ready-to-paste copy for itch.io, directory submissions, and outreach.
Everything here is factual — do not add claims not backed by the shipped game.
...
| | |
|---|---|
| **Title** | Lil Blunt: The Smoke Realm |
| **Also known as** | Lil Blunt Adventure |
| **Developer / Publisher** | Young Stunners |
| **Genre** | 2D platformer, arcade, indie, Web3 |
| **Platform** | Web browser (HTML5), Internet Computer |
| **Price** | Free |
| **Engine** | Godot 4.3 |
...
> You are Lil Blunt, a green outlaw prospector working a claim in the Smoke
> Realm. Run and jump your way through the Dustrock Mines, leap the mine carts,
> dodge the hazards, and get as deep as you can before your lives run out.
>
> Every run is a fresh claim, and your best ones land on the wanted board — the
...
> **Dig deep. Stack your score. Don't let the Tax Man take the cut.**
>
> Lil Blunt: The Smoke Realm is a free 2D side-scrolling platformer set in an
> 1800s Wild West mining town. You play Lil Blunt, a green outlaw prospector
> with a claim in the Dustrock Mines and a strong opinion about taxation.
>
> **The run.** Move, jump, and time your way past mine carts and hazards as you
> push deeper into the shaft. The further you get, the higher your score climbs
> — and the more you have to lose. Each attempt is a fresh claim, so the loop is
> quick: die, learn the timing, go again.
>
...
> crystal-blue veins; and GOLD, the dusty saloon boards of the gold rush.
>
> Free to play. Runs in your browser. Chill vibes only — you can't tax the vibe.

---

## itch.io setup checklist

- [ ] Paste the **medium** description into the short-description field
- [ ] Paste the **long** description into the page body
- [ ] Upload 5–6 gameplay screenshots plus one title screen
- [ ] Upload a 3–5 second gameplay GIF (itch.io autoplays this in the header —
      it is the single biggest click-through lever on the page)
- [ ] Tags: `platformer` `2d` `web3` `indie` `free` `browser` `arcade`
      `pixel-art` `blockchain` `icp` `high-score` `singleplayer`
- [ ] Set **Kind of project**: HTML
- [ ] Set **Release status**: Released
- [ ] Set a release date
- [ ] Enable comments
- [ ] Link smokegame.win, X, and Telegram in the links section
- [ ] Set the cover image to 630×500 (itch.io's preferred ratio)
...
- Built in Godot 4.3, exported to HTML5
- Set across three connected protocols: SMOKE, DIAMONDS, and GOLD

---

## Boilerplate — "about the developer"

> Young Stunners builds Lil Blunt: The Smoke Realm, a free browser platformer
> and the connected SMOKE, DIAMONDS, and GOLD protocols, on the Internet
> Computer.
